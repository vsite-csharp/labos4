...
namespace Vsite.CSharp.Labos4.Primjer2
{
    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            //    select new {ucenik.ImePrezimeUčenika, ucenik.RazredUčenika, profesor.ImePrezimeProfesora};
            var upit = from ucenik in popisNajboljihUčenika
                from profesor in listaProfesora where profesor.JeRazrednikRazredu == ucenik.RazredUčenika
                       select new { ucenik.ImePrezimeUčenika, ucenik.RazredUčenika, profesor.ImePrezimeProfesora };
