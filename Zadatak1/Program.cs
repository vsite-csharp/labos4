    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            var studenti = new List<Student>
            {
                ...
                new Student{ ImePrezime = "Pero Kvrgić", Ispiti = new Ispit[]{ new Ispit {Naziv = "Fizika", Ocjena=5 } } },
                new Student{ ImePrezime = "Lana Jurčević", Ispiti = new Ispit[]{ new Ispit {Naziv = "Vjeronauk", Ocjena=2 }, new Ispit { Naziv = "Matematika", Ocjena = 5 } } },
                new Student{ ImePrezime = "Lidija Bačić", Ispiti = new Ispit[]{ new Ispit {Naziv = "Tjelesna kultura", Ocjena=5 }, new Ispit { Naziv = "Vjeronauk", Ocjena = 5 } } },
            ...
            var studentiNaIspitu = from student in studenti from ispit in student.Ispiti where ispit.Naziv == "Matematika" select student;
