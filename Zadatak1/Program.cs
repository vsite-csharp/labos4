        ...
        static void Main(string[] args)
        {
            ...
            var studenti = new List<Student>
            {
                ...
                {ImePrezime = "Pero Perić",
                 ...
                 new Student
                {ImePrezime = "Pero Kvrgić",
                    Ispiti = new Ispit[]{ new Ispit {Naziv = "Matematika", Ocjena=5}, 
                        new Ispit {Naziv = "Fizika", Ocjena=3}}},
                  new Student
                {ImePrezime = "Lana Jurčević",
                    Ispiti = new Ispit[]{ new Ispit {Naziv = "Matematika", Ocjena=3},
                        new Ispit {Naziv = "Vjeronauk", Ocjena=2}}},
                   new Student
                {ImePrezime = "Lidija Bačić",
                    Ispiti = new Ispit[]{ new Ispit {Naziv = "Matematika", Ocjena=5},
                        new Ispit {Naziv = "Fizika", Ocjena=2}}},
                   new Student
                {ImePrezime = "Andre Agassi",
                    Ispiti = new Ispit[]{ } },
            ...
            var studentiNaIspitu = from student in studenti
                                   ...
                                   where ispit.Naziv == imePredmeta select student;      //where student.Ispiti.Length > 0 select student;
