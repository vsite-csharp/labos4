...
namespace Vsite.CSharp.Labos4.Zadatak1
{
    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            {
                new Student{ ImePrezime = "Pero Perić",
                    Ispiti = new Ispit[]{ new Ispit{ Naziv="Matematika", Ocjena=1} } },
                new Student{ ImePrezime = "Pero Kvrgić",
                    Ispiti = new Ispit[]{ new Ispit{ Naziv="Fizika", Ocjena=5}, new Ispit { Naziv = "Matematika", Ocjena = 3 } } },
                new Student{ ImePrezime = "Lana Jurčević",
                    Ispiti = new Ispit[]{ new Ispit{ Naziv="Vjeronauk", Ocjena=2}, new Ispit { Naziv = "Matematika", Ocjena = 3 } } },
                new Student{ ImePrezime = "Lidija Bačić",
                    Ispiti = new Ispit[]{ new Ispit{ Naziv="Tjelesna kultura", Ocjena=5}, new Ispit { Naziv = "Fizika", Ocjena = 4 } } },
                new Student{ ImePrezime = "Andrej Plenković",
                    Ispiti = new Ispit[]{  } },
            };
