    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            var studenti = new List<Student>
            {
                ...
                new Student {ImePrezime = "Lile Bačić",
                    Ispiti = new Ispit[]
                    {
                        new Ispit{Naziv = "Tjelesna Kultura", Ocjena = 5},
                        new Ispit{Naziv = "Fizika", Ocjena = 2}
                    }},
                new Student {ImePrezime = "Adre Agassi",
                    Ispiti = new Ispit[] { }}
            };
            ...
            //var studentiNaIspitu = from student in studenti where student.Ispiti.Length > 0 select student;
