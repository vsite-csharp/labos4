        ...
        static void Main(string[] args)
        {
            ...
            var studenti = new List<Student> 
            {
                ...
                new Student {ImePrezime = "Pero Kvrgić", 
                    Ispiti = new Ispit[]{ new Ispit{Naziv = "Fizika", Ocjena = 5}, 
                        new Ispit{Naziv = "Matematika", Ocjena = 3} } }, 
                new Student {ImePrezime = "Lana Jurčević", 
                    Ispiti = new Ispit[]{ new Ispit{Naziv = "Fizika", Ocjena = 5}, 
                        new Ispit{Naziv = "Matematika", Ocjena = 3} } }, 
                new Student {ImePrezime = "Andrija Jarak", 
                    Ispiti = new Ispit[]{ new Ispit{Naziv = "Fizika", Ocjena = 5}, 
                        new Ispit{Naziv = "Tjelesna kultura", Ocjena = 1} } }, 
                new Student {ImePrezime = "Minal Bandić", 
                    Ispiti = new Ispit[]{ } },
            };
