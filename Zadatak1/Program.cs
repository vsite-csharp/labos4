    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            var studenti = new List<Student>
            {
                ...
                new Student { ImePrezime = "Pero Kvrgić", Ispiti = new Ispit[] { new Ispit {Naziv = "Fizika", Ocjena = 5}, new Ispit { Naziv = "Matematika", Ocjena = 5 }}},
                new Student { ImePrezime = "Lana Jurčević", Ispiti = new Ispit[] { new Ispit {Naziv = "Vjeronauk", Ocjena = 5}, new Ispit { Naziv = "Geografija", Ocjena = 5 }}},
                new Student { ImePrezime = "Andrej Plenković", Ispiti = new Ispit[] { }}
            };
