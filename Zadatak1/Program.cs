    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            var studenti = new List<Student>
            {
                ...
                new Student{ ImePrezime = "Mate Mišo Kovač",
                    Ispiti = new Ispit[]{ new Ispit{Naziv = "Vjeronauk", Ocjena = 3}, new Ispit{ Naziv = "Povijest", Ocjena=4 } } },                
                new Student{ ImePrezime = "Niko Kovač",
                    Ispiti = new Ispit[]{  } },
