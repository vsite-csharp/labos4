    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            var studenti = new List<Student>
            {
                ...
                new Student{ ImePrezime="Lana Jurčević", Ispiti = new Ispit[]{ new Ispit{Naziv = "Vjeronauk", Ocjena = 2 }, new Ispit { Naziv = "Matematika", Ocjena = 3 } } },
                new Student{ ImePrezime="Andrea Vrljić", Ispiti = new Ispit[]{ new Ispit{Naziv = "Informatika", Ocjena = 5 }, new Ispit { Naziv = "Matematika", Ocjena = 5 } } },
                new Student{ ImePrezime="Ana Lovrić", Ispiti = new Ispit[]{ } },
            };
